...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@sd-core/composables';
import { X } from '@sd-core/icons';
import {
  Sheet,
  SheetClose,
  SheetContent,
...
import { cn } from '@sd-core/shared/utils';
  ...
  >
    ...
    >
        ...
        <div>
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <SdHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </SdHelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <div
        ...
        "
      >
        <SdLoading v-if="showLoading" class="size-full" spinning />
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || SdButton"
          ...
          <component
            :is="components.PrimaryButton || SdButton"
