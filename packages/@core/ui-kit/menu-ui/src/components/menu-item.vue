...
import { useNamespace } from '@sd-core/composables';
import { SdIcon, SdTooltip } from '@sd-core/shadcn-ui';
  ...
  >
    ...
    >
      <template #trigger>
        <div :class="[nsMenu.be('tooltip', 'trigger')]">
          <SdIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
          <slot></slot>
    ...
    <div v-show="!showTooltip" :class="[e('content')]">
      <MenuBadge
        ...
        v-bind="props"
      />
      <SdIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
      <slot></slot>
      <slot name="title"></slot>
    </div>
  </li>
