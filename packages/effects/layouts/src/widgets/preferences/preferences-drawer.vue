...
import type { SegmentedItem } from '@sd-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '@sd/icons';
import { $t, loadLocaleMessages } from '@sd/locales';
import {
...
import { useSdDrawer } from '@sd-core/popup-ui';
import {
  SdButton,
  SdIconButton,
  SdSegmented,
...
<template>
  <div>
    ...
    >
      ...
      <div class="p-1">
        <SdSegmented v-model="activeTab" :tabs="tabs">
          <template #general>
