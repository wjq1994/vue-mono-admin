...
import { Bell, MailCheck } from '@sd/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <SdIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <SdScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <SdButton size="sm" @click="handleViewAll">
