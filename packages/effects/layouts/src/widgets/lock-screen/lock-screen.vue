...
import { LockKeyhole } from '@sd/icons';
import { $t, useI18n } from '@sd/locales';
import { storeToRefs, useLockStore } from '@sd/stores';
import { useScrollLock } from '@sd-core/composables';
import { useSdForm, z } from '@sd-core/form-ui';
import { SdAvatar, SdButton } from '@sd-core/shadcn-ui';
...
const [Form, { form, validate }] = useSdForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'SdInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[300px]">
          <SdAvatar :src="avatar" class="enter-x mb-6 size-20" />

          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <SdButton class="enter-x w-full" @click="handleSubmit">
