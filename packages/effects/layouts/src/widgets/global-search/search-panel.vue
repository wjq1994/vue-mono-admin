...
import type { MenuRecordRaw } from '@sd/types';

import { nextTick, onMounted, ref, shallowRef, watch } from 'vue';
import { useRouter } from 'vue-router';

import { SearchX, X } from '@sd/icons';
import { $t } from '@sd/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@sd/utils';
import { SdIcon, SdScrollbar } from '@sd-core/shadcn-ui';
import { isHttpUrl } from '@sd-core/shared/utils';
