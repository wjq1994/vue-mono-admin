import type { TabDefinition } from '@sd/types';
import type { IContextMenuItem } from '@sd-core/tabs-ui';
import type { RouteLocationNormalizedGeneric } from 'vue-router';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@sd/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { useAccessStore, useTabbarStore } from '@sd/stores';
import { filterTree } from '@sd/utils';
