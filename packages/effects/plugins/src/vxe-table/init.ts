...
export let useTableForm: typeof useSdForm;
...
export function setupSdVxeTable(setupOptions: SetupVxeTable) {
  const { configVxeTable, useSdForm } = setupOptions;

  initVxeTable();
  useTableForm = useSdForm;
